  ...
  it('dueDate data', () => {
    const newState = FormReducer(currentState, {
      ...
      payload: {
        field: 'dueDate',
        data: {
          selectedDate: '28/04/1988',
        },
      },
    });
    expect(newState.dueDate.selectedDate).toEqual('28/04/1988');
  });
  ...
  it('note data', () => {
    const newState = FormReducer(currentState, {
      ...
      payload: {
        field: 'note',
        data: {
          content: 'Proof that Tony Stark has a heart',
        },
      },
    });
    expect(newState.note.content).toEqual('Proof that Tony Stark has a heart');
      ...
      rows: [
        {
          ...
          description: 'EVGA GeForce RTX 2080 TI FTW3 Ultra Hybrid Gaming',
          price: 1390,
          quantity: 1,
          subtotal: 1390,
        },
